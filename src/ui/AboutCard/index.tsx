  ...
  return (
    ...
    >
      ...
      >
        ...
        <section className="w-full h-[calc(100%-3rem)] mt-2 p-2 overflow-y-auto text-start scrollbar-thin scrollbar-track-transparent scrollbar-thumb-shark-900 text-shark-950/75 dark:scrollbar-thumb-shark-100 dark:text-shark-50/75">
          {children}
        </section>
      </button>
    </article>
